...
<body class="hidden hidden-ball smooth-scroll" data-primary-color="#ff0000">
                                ...
                                <div class="outer">
                                    <div class="inner">
                                        <ul data-breakpoint="10025" class="flexnav">
                                            <li class="link menu-timeline"><a class="ajax-link active" data-type="page-transition" href="../../FAMEDD/index.php">
                    ...
                    <div id="main">
                                    ...
                                    <div class="inner">
                                        ...
                                        <div class="one_half last">
                                            <div class="hero-text"><span>FAMEDD develops, designs and delivers websites
                                                    ...
                                                    for itself.</span></div>
                                            <br>
                                            <div class="button-wrap right disable-drag large-btn has-animation">
                                                <div class="icon-wrap parallax-wrap">
                                                    <div class="button-icon parallax-element">
                        ...
                        <div id="hero-image-wrapper">
                            <div id="hero-background-layer" class="parallax-scroll-image">
                                <div id="hero-bg-image" style="background-image:url(images/about.jpg)"></div>
                            </div>
                        </div>
                        <!--/Hero Section -->
                                ...
                                <div class="content-row full light-section" data-bgcolor="#fff">
                                    ...
                                    <div class="content-row row_padding_top row_padding_bottom light-section change-header-color" data-bgcolor="#fff">
                                        ...
                                        <div class="two_fourth">
                                            <h1 class="big-title has-mask-fill">Our Company</h1>
                                        </div>
                                        ...
                                        <div class="two_fourth">
                                            <p class="has-animation" data-delay="50">Our company provides a vast range
                                                of features that you might require. From creating a one pager to
                                                providing a fully
                                                functional multi page website with an optimised backend we can do it
                                                all, we also provide a vast number of services like
                                                running a campaign for your website or managing it<br><br>We can also
                                                write content for your blog or business or can professionally edit your
                                                videos or if your want an app for
                                                your business worry not we can do that too for you.</p>
                                        </div>
                                    ...
                                    <!-- Row -->
                                    <div class="content-row row_padding_bottom light-section change-header-color full" data-bgcolor="#fff">

                                        <div class="moving-gallery random-sizes fw-gallery">
                                            <ul class="wrapper-gallery">
                                                <li>
                                                    <img src="images/studio01.jpg">
                                                </li>
                                                <li>
                                                    <img src="images/studio02.jpg">
                                                </li>
                                                <li>
                                                    <img src="images/studio03.jpg">
                                                </li>
                                                <li>
                                                    <img src="images/studio04.jpg">
                                                </li>
                                            </ul>
                                        </div>

                                        <div class="moving-gallery random-sizes bw-gallery">
                                            <ul class="wrapper-gallery">
                                                <li>
                                                    <img src="images/studio02.jpg">
                                                </li>
                                    ...
                                    <!-- <div class="content-row row_padding_left row_padding_right full light-section change-header-color"
                                        ...
                                        <div class="two_fourth">
                                            <h1 class="big-title has-mask-fill">Our Team</h1>
                                        </div>
                                        ...
                                        <div class="two_fourth">
                                            <p class="has-animation" data-delay="50">Our team consist of 20 people
                                                specialized in their field of work providing top notch services. The
                                                founders of famed are.</p>
                                        </div>
                                    ...
                                    <div class="content-row row_padding_bottom row_padding_left row_padding_right full light-section change-header-color"
                                        ...
                                        <div class="three_fourth last">
                                            ...
                                            <ul class="team-members-list" data-fx="1">
                                                <li class="link has-hover-image" data-img="images/farhan.jpg"
                                                    onclick="return fk()">
                                                    <div class="team-member has-animation">
                                                        <div>Farhan khalid</div><span>Backend Developer</span>
                                                    </div>
                                                </li>
                                                <li class="link has-hover-image" data-img="images/intro-bg..jpg"
                                                    onclick="return Aa()">
                                                    <div class="team-member has-animation">
                                                        <div>Aaquib Akhtar</div><span>Frontend Developer</span>
                                                    </div>
                                                </li>
                                            </ul>
                                   ...
                                   <!-- Row -->
                                    <div class="content-row full light-section" data-bgcolor="#fff">
                                        ...
                                        <!-- Row -->
                                        <div class="content-row row_padding_top row_padding_bottom row_padding_left row_padding_right full light-section change-header-color" data-bgcolor="#fff">

                                            <h6 class="has-icon">Our Services</h6>
                                            <hr>
                                            <h1 class="has-mask-fill no-margins">Strategic</h1>
                                            <h1 class="has-mask-fill">Case Approach</h1>
                                            <hr>
                                            <hr>
                                        ...
                                        <div class="content-row light-section change-header-color" data-bgcolor="#fff">
                                            ...
                                            <div class="one_third vertical-parallax" data-startparallax="-0.1" data-endparallax="0">
                                                <div class="box-icon-wrapper block-boxes">
                                                    ...
                                                    <div class="box-icon-content">
                                                        <h4 class="no-margins">Digital Interfaces</h4>
                                                        <p>We create interfaces, whether your business sells directly to
                                                            consumers or other businesses, for any smart device type or
                                                            screen size.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="one_third last vertical-parallax" data-startparallax="-0.5" data-endparallax="0">
                                                <div class="box-icon-wrapper block-boxes">
                                                    ...
                                                    <div class="box-icon-content">
                                                        <h4 class="no-margins">Creative Production</h4>
                                                        <p>We take all your ideas and thoughts mix it with our own creative
                                                            inputs and bring the and bring the whole concept to
                                                            fruition.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <!-- Row -->
                                        <div class="content-row row_padding_bottom row_padding_left row_padding_right full light-section change-header-color" data-bgcolor="#fff">
                                        ...
                                        <div class="content-row row_padding_bottom light-section change-header-color" data-bgcolor="#fff">
                                            ...
                                            <div class="one_third vertical-parallax" data-startparallax="-0.4" data-endparallax="-0.1">
                                                <div class="box-icon-wrapper block-boxes">
                                                    ...
                                                    <div class="box-icon-content">
                                                        <h4 class="no-margins">Brand Strategy</h4>
                                                        <p>We create a strategy for your business that allows you to have an
                                                            increased reach and a rapport in your favourable
                                                            market.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="one_third last vertical-parallax" data-startparallax="-0.2" data-endparallax="-0.1">
                                                <div class="box-icon-wrapper block-boxes">
                                                    ...
                                                    <div class="box-icon-content">
                                                        <h4 class="no-margins">Digital Experiences</h4>
                                                        <p>We provide the best possible digital experience for your
                                                            customers that are coming on to your websites or apps for any
                                                            kind of purchase or engagement.</p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="page-nav-wrap">
                                        <div class="page-nav-caption content-max-width block-title marquee-title">
                                            <div class="inner">
                                                ...
                                                <a class="page-title next-ajax-link-page" data-type="page-transition" data-firstline="" data-secondline="Next Page" href="http://localhost/FAMEDD/php/index.php">
                        ...
                        <footer class="">
                            <div id="footer-container">
                                ...
                                <div class="footer-middle">
                                    <div class="copyright">2023 © <a class="link" target="_blank" href="">FAMEDD</a>. All
                                        rights reserved.</div>
                                </div>
    ...
    <script type="text/javascript">
        function myfun2() {
            window.location.assign("aboutus.php");
        }
    </script>
    <script type="text/javascript">
        function myfun3() {
    ...
    <script type="text/javascript">
        function fk() {
            window.location.assign("Farhan Khalid/fk.php");
        }
    </script>
    <script type="text/javascript">
        function Aa() {
            window.location.assign("Aaquib/Aaquib/../index.php");
        }
    </script>
