...
<head>
    <link rel="shortcut icon" href="images/real-logo-faveicon-removebg-preview.png" type="image/x-icon">
    <title>FAMEDD</title>
...
---------------------------------------------------*/
    ...
    *:after {
    ...
    a.elements-campaign-nav__main-link::after {
        content: "";
        height: 3px;
        background: -webkit-linear-gradient(0.02deg, #f73859 0.39%, #6e5cff 99.99%);
        background: linear-gradient(89.98deg, #f73859 0.39%, #6e5cff 99.99%);
        width: 100%;
        position: absolute;
        left: 0;
        bottom: -19px;
    ...
    .elements-nav__dropdown-container a {
        color: #666666;
        padding: 4px 8px;
    }

    .elements-nav__dropdown-container a:hover {
        text-decoration: none;
    }
    ...
    .elements-nav__main-panel .items-collage {
        left: -16px;
        position: absolute;
        width: 250px;
        bottom: -20px;
    ...
    .elements-nav__punch-line span {
        display: block;
    }

    .elements-nav__logo-container {
        height: 22px;
    }

    .elements-nav__selling-points {
        list-style-position: inside;
    }

    .elements-nav__selling-points li {
        margin-bottom: 9px;
        list-style: none;
    }

    .elements-nav__selling-points li::before {
        content: url("data:image/svg+xml,<svg width='14' height='15' fill='none' xmlns='http://www.w3.org/2000/svg'><path d='M7 .833a6.667 6.667 0 1 0 0 13.334A6.667 6.667 0 0 0 7 .833zm2.9 5.154L6.153 9.733a.32.32 0 0 1-.466 0L4.1 8.167a.333.333 0 0 1 0-.474l.353-.353a.32.32 0 0 1 .467 0l1 .993 3.16-3.16a.333.333 0 0 1 .467 0l.353.354a.333.333 0 0 1 0 .46z' fill='%23ACB0EE'/></svg>");
    }
    ...
    .elements-nav__cta a::after {
        content: url("data:image/svg+xml,<svg width='10' height='10' fill='none' xmlns='http://www.w3.org/2000/svg'><path d='M5 .788 9.212 5 5 9.212l-.917-.917 2.64-2.645H.85v-1.3h5.873l-2.64-2.645L5 .788z' fill='%23523EE8'/></svg>");
        -webkit-transition: margin-left 0.3s ease-in-out;
        transition: margin-left 0.3s ease-in-out;
    }

    .elements-nav__cta a:hover::after {
        margin-left: 4px;
    }
    ...
    .elements-nav__category-link::before {
        ...
        -webkit-border-image: -webkit-linear-gradient(92.89deg,
                #f73859 6.56%,
                #6e5cff 113.04%) 1;
    ...
    .svg .header-mini__logo .header-mini__logo--envato-market {
        background: url(/assets/logos/envato_market-dde916a48af7413e54aa058fe7ae6856752fca799da4bec355f00aea904bfa19.svg) 0 10px no-repeat;
        background-size: 152px 18px;
    }
    ...
    .page-section.-custom-badges {
        background: #666 url(/assets/badges/bg-badges-6eebf349b6d8ee7ced4be440ca5e67d25ec10f8dcc1ecff89b1614b32bc13e40.jpg) no-repeat center 100%;
        padding-bottom: 80px;
    }
    ...
    .site-header-cta__center .site-header-cta__center_overflow_wrapper:before {
        ...
        background: -webkit-gradient(linear,
                left top,
                right top,
                from(rgba(73, 157, 182, 0)),
                color-stop(70%, #262626));
    ...
    #CybotCookiebotDialog div {
        font-family: -apple-system, BlinkMacSystemFont, segoe ui, avenir next, avenir,
            helvetica neue, helvetica, ubuntu, roboto, noto, arial, sans-serif !important;
        -webkit-font-smoothing: antialiased;
        -moz-osx-font-smoothing: grayscale;
    ...
    input.CybotCookiebotDialogBodyLevelButton[type="checkbox"]+label {
        background-size: contain !important;
        background-position: top left !important;
    }

    input.CybotCookiebotDialogBodyLevelButton[type="checkbox"]:checked+label {
    ...
    input.CybotCookiebotDialogBodyLevelButton.CybotCookiebotDialogBodyLevelButtonDisabled[type="checkbox"]+label {
    ...
    @font-face {
        ...
        src: url(/assets/marketplace-glyphs/marketplace-glyphs-e72c235d8798e8242163d10f68f4eaa9d6919c4689c705a6c30fe80cf3d4ff9d.eot?#iefix) format("embedded-opentype"),
            url(/assets/marketplace-glyphs/marketplace-glyphs-85cc828ca8d675d6613f41b266689cea348332a12f6966cbe08583f16f208a40.woff) format("woff"),
            url(/assets/marketplace-glyphs/marketplace-glyphs-b94c8b32d03aa7203117cb403f5ad0a09e621925822c3eec0c404e13e0408ea2.ttf) format("truetype"),
            url(/assets/marketplace-glyphs/marketplace-glyphs-497c4a115add7b2c6b95117c155d0f698e5e26954c4b49217034ad39ee66d743.svg#marketplace-glyphs) format("svg");
        font-weight: normal;
        font-style: normal;
    }
    ...
    a:focus .global-header-dropdown__link-text {
        opacity: 1;
    }
    ...
    .global-header-menu__dropdown-container {
        ...
        transition: 0.15s max-height 0.15s linear,
...
<body class="hidden hidden-ball smooth-scroll" data-primary-color="#ff0000">
    ...
    <main>
        <!-- Preloader -->
        <div class="preloader-wrap" data-firstline="" data-secondline="Stay Relaxed">
            <div class="outer">
                <div class="inner">
                    <div class="trackbar">
                        <ul class="preloader-intro">
                            ...
                            <li class="preloader-list">Hola</li> -->
                            <li class="preloader-list">salaam</li>
                            <!-- <li class="preloader-list">Namste</li> -->
                        </ul>
                ...
                <header class="fullscreen-menu invert-header" data-menucolor="#171717">
                    <div id="header-container">
                        ...
                        <div id="logo" class="hide-ball">
                            <a class="ajax-link" data-type="page-transition" href="http://localhost/FAMEDD/index.php">
                                <img onclick="return myfun()" class="black-logo" style="width: 40%; height: 50%;" src="images/A_letter_tech_logo-BLACK-removebg-preview-famedd.png" alt="ClaPat Logo">
                                <img onclick="return myfun()" class="white-logo" src="images/A_letter_tech_logo-removebg-preview.png" alt="ClaPat Logo">
                            </a>
                        </div>
                        <!--/Logo -->
                                ...
                                <div class="outer">
                                    <div class="inner">
                                        <ul data-breakpoint="10025" class="flexnav">
                                            <li class="link menu-timeline"><a class="ajax-link" data-type="page-transition" href="http://localhost/FAMEDD/php/aboutus.php">
                                                    <div class="before-span"><span data-hover="About">About</span></div>
                                                </a></li>
                                            <li class="link menu-timeline"><a class="ajax-link" data-type="page-transition" href="http://localhost/FAMEDD/php/index.php">
                            ...
                            <div id="hero-styles">
                                <div id="hero-caption" class="content-max-width">
                                    <div class="inner">
                                        ...
                                        <div class="hero-subtitle"><span>Digital</span><span>Creative Company</span>
                                        </div>
                                        <div class="hero-title-wrapper">
                                            <div class="hero-title"><span>Inspire </span> <span>Through </span>
                                                <span>Design</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="hero-description" class="content-max-width">
                                    <div class="inner">
                                        ...
                                        <div class="one_half last">
                                            <div class="hero-text"><span>FAMEDD develops, designs and delivers websites
                                                    and creative campaigns that drive results, build awareness and win
                                                    awards. <br><br> Our work never brags, but it sure loves to speak
                                                    for itself.</span></div>
                                            <br>
                                            <div class="button-wrap right button-link large-btn has-animation">
                                                ...
                                                <a class="ajax-link" href="" data-type="page-transition">
                                                    <div class="button-text sticky right"><span data-hover="Read More">Read More</span></div>
                                                </a>
                                            </div>
                        ...
                        <div id="main-content">
                            ...
                            <div id="main-page-content" class="content-max-width">
                                ...
                                <div class="content-row full light-section" data-bgcolor="#fff">
                                    ...
                                    <div class="content-row fadeout-element row_padding_top light-section change-header-color" data-bgcolor="#fff">
                                        ...
                                        <div class="one_half">
                                            ...
                                            <p class="has-animation" data-delay="50">The driving force of all speeches,
                                    ...
                                    <div class="content-row fadeout-element light-section change-header-color" data-bgcolor="#fff">
                                        ...
                                        <div class="marquee-text-wrapper">
                                            <h1 class="marquee-text big-title bw">Everything you can imagine , we can
                                                create.</h1>
                                        </div>
                                    ...
                                    <div class="content-row row_padding_top row_padding_bottom light-section change-header-color full" data-bgcolor="#fff">
                                        ...
                                        <div id="itemsWrapperLinks" class="portfolio-wrap parallax-two-grid content-max-width fade-scaleout-effect">
                                            ...
                                            <div id="itemsWrapper" class="portfolio portfolio-shortcode webgl-fitthumbs fx-three">
                                                ...
                                                <div class="item trigger-item branding design" data-color="#95121e" data-firstline="" data-secondline="View Project" data-scrub="0.2">
                                                    <div class="item-parallax">
                                                        <div class="item-appear">
                                                            <div class="item-content">
                                                                <!-- <a class="item-wrap ajax-link-project"
                                                                   data-type="page-transition"
                                                                   href=""></a> -->
                                                                <div class="item-wrap-image">
                                                                    <img src="images/yes enterprises-2.png" class="item-image grid__item-img trigger-item-link" alt="">
                                                                </div>
                                                                <img class="grid__item-img grid__item-img--large" src="images/yes enterprises.png" alt="" />
                                                            </div>
                                                        </div>
                                                        <div class="item-caption-wrapper">
                                                            <div class="item-caption">
                                                                ...
                                                                <div class="item-cat">YS Enterprises</div>
                                                                <div class="item-title"><span>The</span>
                                                                    <span>Company of</span> <span>Auto parts</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="item vertical-parallax trigger-item design photo" data-color="#963a8d" data-firstline="" data-secondline="View Project" data-scrub="0.5">
                                                    <div class="item-parallax">
                                                        <div class="item-appear">
                                                            <div class="item-content">
                                                                <!-- <a class="item-wrap ajax-link-project"
                                                                   ...
                                                                   href=""></a> -->
                                                                <div class="item-wrap-image">
                                                                    <img src="images/webaroon-2.png" class="item-image grid__item-img trigger-item-link" alt="">
                                                                </div>
                                                                <img class="grid__item-img grid__item-img--large" src="images/webaroon.png" alt="" />
                                                            </div>
                                                        </div>
                                                        <div class="item-caption-wrapper">
                                                            <div class="item-caption">
                                                                <div class="item-arrow"><i class="arrow-icon"></i></div>
                                                                <div class="item-date">2023</div>
                                                                <div class="item-cat">Webaroon</div>
                                                                <div class="item-title"><span>Designing</span>
                                                                    <span>Company</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="item vertical-parallax trigger-item design photo change-header" data-color="#a77e69" data-firstline="" data-secondline="View Project" data-scrub="0.2">
                                                    <div class="item-parallax" style="border: 0.5px solid #EEEEEE;">
                                                        <div class="item-appear">
                                                            <div class="item-content">
                                                                <!-- <a class="item-wrap ajax-link-project"
                                                                   data-type="page-transition"
                                                                   href=""></a> -->
                                                                <div class="item-wrap-image">
                                                                    <img src="images/fueltoys-2.png" class="item-image grid__item-img trigger-item-link" alt="">
                                                                </div>
                                                                <img class="grid__item-img grid__item-img--large" src="images/fueltoys.png" alt="" />
                                                            </div>
                                                        </div>
                                                        <div class="item-caption-wrapper">
                                                            <div class="item-caption">
                                                                <div class="item-arrow"><i class="arrow-icon"></i></div>
                                                                <div class="item-date">2023</div>
                                                                <div class="item-cat">Fueltoys</div>
                                                                <div class="item-title"><span>The Company</span>
                                                                    <span style="color: white;">of Car</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="item trigger-item video" data-color="#3d5662" data-firstline="" data-secondline="View Project" data-scrub="0.5">
                                                    <div class="item-parallax">
                                                        <div class="item-appear">
                                                            <div class="item-content">
                                                                <!-- <a class="item-wrap ajax-link-project"
                                                                   ...
                                                                   href=""></a> -->
                                                                <div class="item-wrap-image">
                                                                    <img src="images/integrated solutions-2.png" class="item-image grid__item-img trigger-item-link" alt="">
                                                                </div>
                                                                <img class="grid__item-img grid__item-img--large" src="images/integrated solutions.png" alt="" />
                                                            </div>
                                                        </div>
                                                        <div class="item-caption-wrapper">
                                                            <div class="item-caption">
                                                                <div class="item-arrow"><i class="arrow-icon"></i></div>
                                                                <div class="item-date">2023</div>
                                                                <div class="item-cat">integrated solutions</div>
                                                                <div class="item-title"><span>The Company</span>
                                                                    <span>Of
                                                                        Swing Machines</span>
                                                                </div>
                                    ...
                                    <div class="content-row fadeout-element row_padding_bottom light-section change-header-color" data-bgcolor="#fff">
                                        ...
                                        <div class="one_half">
                                            ...
                                            <div class="button-wrap right button-link large-btn has-animation">
                                                ...
                                                <a class="ajax-link" href="" data-type="page-transition">
                                                    <div class="button-text sticky right"><span data-hover="View all Works">View all Works</span></div>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="content-row full light-section" data-bgcolor="#fff">
                                    ...
                                    <!-- Row -->
                                    <div class="content-row row_padding_top light-section change-header-color" data-bgcolor="#fff">
                                        ...
                                        <div class="one_half">
                                            ...
                                            <p class="has-animation" data-delay="0">Blogs features
                                                there are varities of feature that our company provides from creating a
                                                page to creating an identity for your business
                                                everything you can imagine we can create.</p>
                                    ...
                                    <div class="content-row light-section full change-header-color" data-bgcolor="#fff">
                                        ...
                                        <div class="panels news-panel">
                                            ...
                                            <div class="panels-container">
                                                ...
                                                <div class="panel" data-color="#000" data-firstline="" data-secondline="Read Story">
                                                    <div class="panel-content-wrapper">
                                                        <div class="panel-image">
                                                            <a class="ajax-link" href="index.php" data-type="page-transition"><img src="images/news01.jpg"></a>
                                                        </div>
                                                        <div class="panel-content">
                                                            <div class="entry-meta entry-categories">
                                                                <ul class="post-categories">
                                                                    <li class="link"><a href="#"><span data-hover="Insights">Insights</span></a>
                                                                    </li>
                                                                    <li class="link"><a href="#"><span data-hover="Nature">Nature</span></a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                ...
                                                <div class="panel" data-color="#000" data-firstline="" data-secondline="Read Story">
                                                    <div class="panel-content-wrapper">
                                                        <div class="panel-image">
                                                            <a class="ajax-link" href="index.php" data-type="page-transition"><img src="images/news02.jpg"></a>
                                                        </div>
                                                        <div class="panel-content">
                                                            <div class="entry-meta entry-categories">
                                                                <ul class="post-categories">
                                                                    ...
                                                                    <li class="link"><a href="#"><span data-hover="Work">Work</span></a></li>
                                                                </ul>
                                                            </div>
                                                ...
                                                <div class="panel" data-color="#000" data-firstline="" data-secondline="Read Story">
                                                    <div class="panel-content-wrapper">
                                                        <div class="panel-image">
                                                            <a class="ajax-link" href="index.php" data-type="page-transition"><img src="images/news03.jpg"></a>
                                                        </div>
                                                        <div class="panel-content">
                                                            <div class="entry-meta entry-categories">
                                                                <ul class="post-categories">
                                                ...
                                                <div class="panel change-header" data-color="#000" data-firstline="" data-secondline="Read Story">
                                                    <div class="panel-content-wrapper">
                                                        <div class="panel-image">
                                                            <a class="ajax-link" href="index.php" data-type="page-transition"><img src="images/news04.jpg"></a>
                                                        </div>
                                                        <div class="panel-content">
                                                            <div class="entry-meta entry-categories">
                                                                <ul class="post-categories">
                                                ...
                                                <div class="panel" data-color="#000" data-firstline="" data-secondline="Read Story">
                                                    <div class="panel-content-wrapper">
                                                        <div class="panel-image">
                                                            <a class="ajax-link" href="index.php" data-type="page-transition"><img src="images/news05.jpg"></a>
                                                        </div>
                                                        <div class="panel-content">
                                                            <div class="entry-meta entry-categories">
                                                                <ul class="post-categories">
                                                ...
                                                <div class="panel" data-color="#000" data-firstline="" data-secondline="Read Story">
                                                    <div class="panel-content-wrapper">
                                                        <div class="panel-image">
                                                            <a class="ajax-link" href="index.php" data-type="page-transition"><img src="images/news06.jpg"></a>
                                                        </div>
                                                        <div class="panel-content">
                                                            <div class="entry-meta entry-categories">
                                                                <ul class="post-categories">
                                    ...
                                    <div class="content-row row_padding_bottom light-section change-header-color" data-bgcolor="#fff">
                                        ...
                                        <div class="one_half">
                                            ...
                                            <div class="button-wrap right button-link large-btn has-animation">
                                                ...
                                                <a class="ajax-link" href="" data-type="page-transition">
                                                    <div class="button-text sticky right"><span data-hover="Go To Blog">Go To Blog</span></div>
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div id="page-nav">
                                <div class="page-nav-wrap">
                                    <div class="page-nav-caption content-max-width block-title marquee-title">
                                        <div class="inner">
                                            <div class="hero-arrow"><i class="arrow-icon"></i></div>
                                            <div class="next-hero-subtitle"><span>About our FAMEDD</span></div>
                                            <a class="page-title next-ajax-link-page" data-type="page-transition" data-firstline="" data-secondline="Next Page" href="http://localhost/FAMEDD/php/aboutus.php">
                                                <div class="next-hero-title-wrapper">
                                                    <div class="next-hero-title">
                                                        <span>Creative websites Desgin -</span>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                    ...
                    <footer class="">
                        <div id="footer-container">
                            ...
                            <div class="footer-middle">
                                <div class="copyright">2023 © <a class="link" target="_blank" href="https://famedd.com/">FAMEDD</a>. All rights reserved.</div>
                            </div>
                            ...
                            <div class="socials-wrap">
                                ...
                                <ul class="socials">
                                    ...
                                    <li><span class="parallax-wrap"><a class="parallax-element" href="" target="_blank">Tw</a></span>
                                    </li>
                                    <li><span class="parallax-wrap"><a class="parallax-element" href="" target="_blank">Be</a></span></li>
                                    <li><span class="parallax-wrap"><a class="parallax-element" href="" target="_blank">Fb</a></span>
                                    </li>
                                    <li><span class="parallax-wrap"><a class="parallax-element" href="">In</a></span>
                                    </li>
                                </ul>
                            </div>
    ...
    <script type="text/javascript">
        function myfun() {
            window.location.assign("http://localhost/FAMEDD/index.php");
        }
    </script>
    <script type="text/javascript">
        function myfun2() {
            window.location.assign("php/aboutus.php");
        }
    </script>
    <script type="text/javascript">
        function myfun3() {
